...
import { users, profiles, blocks } from "../src/db/schema";
import { eq } from "drizzle-orm";
import { createClient } from "@supabase/supabase-js";
import { randomUUID } from "node:crypto";

async function migrateKepexeUser() {
  console.log("Starting migration for kepexe@gmail.com...");
  ...
  console.log(`   Profile URL: /@${username}`);
  console.log(`   Email: ${email}`);
  console.log(`   Password: ${password}`);
  console.log(`   Total Blocks: ${blocksData.length}`);
}
