      ...
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-blue-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
          ...
          <p className="text-zinc-600 mb-6">
            Magic link telah dikirim ke <strong>{email}</strong>. Klik link di email untuk login otomatis.
          </p>
          <button
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-blue-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full">
        <h1 className="text-3xl font-bold text-zinc-900 mb-2">Magic Link Login</h1>
        <p className="text-zinc-600 mb-6">
          Masukkan email Anda dan kami akan mengirimkan link untuk login tanpa password
        </p>
