...
export default function ProfileCard({ profile }: ProfileCardProps) {
  ...
  if (profile.username === 'sugenghariadi' || profile.username === 'kepexe') {
    console.log(`[ProfileCard] ${profile.username}: coverImageUrl=${profile.coverImageUrl}`);
  }
  ...
  return (
    ...
    >
      <div className="relative flex-1 overflow-hidden">
        ...
        {/* Overlay with Profile Info - Only shown when there's a cover image */}
        {profile.coverImageUrl && (
          <div
      ...
      {/* Bottom Section: View and Like - Always Visible */}
