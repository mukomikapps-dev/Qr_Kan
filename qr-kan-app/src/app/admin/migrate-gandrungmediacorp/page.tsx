...
export default function MigrateGandrungMediaCorpPage() {
  ...
  const handleMigrate = async () => {
    ...
    try {
      const response = await fetch("/api/migrate-gandrungmediacorp", {
        method: "POST",
      });
    ...
    <div className="min-h-screen bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 p-8">
      <div className="max-w-2xl mx-auto">
        <div className="bg-zinc-800/50 backdrop-blur-sm border border-zinc-700 rounded-2xl shadow-2xl p-8">
          <h1 className="text-3xl font-bold text-white mb-6">Migrate Gandrung Media Corp User</h1>

          <div className="mb-6">
            <p className="text-zinc-300 mb-4">
              This will create/update the user account for gandrungmediacorp@gmail.com with all content blocks.
            </p>
            <button
